...
LICENSE는 [CC BY-NC-SA 4.0 License](https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode)를 따르며
수정/재배포 허용, 비상업적 사용, 오픈소스 취지의 유지는 허용되며
수정 후 재판매는 금지됩니다.

개발 완료 이후 관련 설정 정보 추가 예정입니다