ALTER TABLE command_mapping_rule ADD COLUMN ack_pattern TEXT;
ALTER TABLE command_mapping_rule ADD COLUMN ack_mask TEXT;
ALTER TABLE command_mapping_rule ADD COLUMN ack_timeout_ms INTEGER;
ALTER TABLE command_mapping_rule ADD COLUMN retry_delay_ms INTEGER;
ALTER TABLE command_mapping_rule ADD COLUMN max_retries INTEGER;
...
-- Outlet deliberately has no packet ACK: state confirmation completes it.
